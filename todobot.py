...
def reminder_callback(context):
    ...
    new_job = job_queue.run_once(check_reminder_callback, datetime.timedelta(minutes=10), context={'chat_data': chat_data, 'job_queue': job_queue, 'header': current_header, 'chat_id': chat_id})
...
def group_work_snooze_reminder(update, context):
    ...
    if current_header not in context.chat_data['reminders']['work']:
        ...
        old_job.schedule_removal()
        new_job = context.job_queue.run_once(check_reminder_callback, datetime.timedelta(minutes=10), context={'chat_data': context.chat_data, 'job_queue': context.job_queue, 'header': current_header, 'chat_id': str(query.message.chat_id)})
...
def module_reminder_callback(context):
    ...
    new_job = context.job_queue.run_once(module_check_reminder_callback, datetime.timedelta(minutes=10), context={'chat_data': chat_data, 'job_queue': job_queue, 'header': current_header, 'chat_id': chat_id})
...
def module_snooze_reminder(update, context):
    ...
    if current_header not in context.chat_data['reminders']['module']:
        ...
        old_job.schedule_removal()
        new_job = context.job_queue.run_once(module_check_reminder_callback, datetime.timedelta(minutes=10), context={'chat_data': context.chat_data, 'job_queue': context.job_queue, 'header': current_header, 'chat_id': str(query.message.chat_id)})
...
def cca_callback(context):
    ...
    new_job = context.job_queue.run_once(cca_check_reminder_callback, datetime.timedelta(minutes=10), context={'chat_data': chat_data, 'user_data': user_data, 'job_queue': job_queue, 'title': current_title, 'chat_id': chat_id})
...
def cca_snooze_reminder(update, context):
    ...
    if current_title not in context.chat_data['reminders']['cca']:
        ...
        old_job.schedule_removal()
        new_job = context.job_queue.run_once(cca_check_reminder_callback, datetime.timedelta(minutes=10), context={'chat_data': context.chat_data, 'job_queue': context.job_queue, 'user_data': context.user_data, 'title': current_title, 'chat_id': str(query.message.chat_id)})
...
def leisure_callback(context):
    ...
    new_job = context.job_queue.run_once(leisure_check_reminder_callback, datetime.timedelta(minutes=10), context={'chat_data': chat_data, 'user_data': user_data, 'job_queue': job_queue, 'title': current_title, 'chat_id': chat_id})
...
def leisure_snooze_reminder(update, context):
    ...
    if current_title not in context.chat_data['reminders']['leisure']:
        ...
        old_job.schedule_removal()
        new_job = context.job_queue.run_once(leisure_check_reminder_callback, datetime.timedelta(minutes=10), context={'chat_data': context.chat_data, 'user_data': context.user_data, 'job_queue': context.job_queue, 'title': current_title, 'chat_id': str(query.message.chat_id)})
...
def help_group_work_to_do_list(update, context):
    ...
    context.bot.send_photo(chat_id=query.message.chat_id, photo=open(r"Instructions_Group_Work_1.jpg", 'rb'))
...
def help_group_work_reminders(update, context):
    ...
    context.bot.send_photo(chat_id=query.message.chat_id, photo=open(r"Instructions_Group_Work_2.jpg", 'rb'))
    help_group_work_return_menu(update, context)
...
def help_module_view_and_edit_module(update, context):
    ...
    context.bot.send_photo(chat_id=query.message.chat_id, photo=open(r"Instructions_Module_1.jpg", 'rb'))
...
def help_module_reminders(update, context):
    ...
    context.bot.edit_message_text(chat_id=query.message.chat_id,
                                  ...
                                  text=add_escape_to_string("Eh you see below got images right, so you can refer to the images below for clearer illustration if the words are making you even more blur." + "\n\n"
                                                            ...
                                                            "Okok I talk finish liao, faster go do your work! 🤧"),
                                                            parse_mode=telegram.ParseMode.MARKDOWN_V2)
    context.bot.send_photo(chat_id=query.message.chat_id, photo=open(r"Instructions_Module_2.jpg", 'rb'))
    help_module_return_menu(update, context)
...
def help_cca(update, context):
    ...
    context.bot.send_photo(chat_id=query.message.chat_id, photo=open(r"Instructions_CCA.jpg", 'rb'))
    help_cca_and_leisure_return_menu(update, context)                                
...
def help_leisure(update, context):
    ...
    context.bot.send_photo(chat_id=query.message.chat_id, photo=open(r"Instructions_Leisure_Activity.jpg", 'rb'))
    help_cca_and_leisure_return_menu(update, context)
...
def main():
    ...
    updater = Updater(token='1347940499:AAHRH7u0KI4zD3SPqx-GVuRD1Jiz4uL9WSs',
    ...
    convo_handler = ConversationHandler(
        ...
        states={
            ...
            GROUP_WORK_REMOVE_REMINDER_MENU: [CallbackQueryHandler(group_work_remove_reminder_user_choice, pattern='work_reminder_')],
            ...
            MODULE_REMOVE_REMINDER_MENU: [CallbackQueryHandler(module_remove_reminder_user_choice, pattern='module_reminder_')],
    ...
    updater.dispatcher.add_handler(MessageHandler(Filters.regex('@doYourWorkLahBot /sendCCApoll' + "\n"), cca_add_session_done_clicked)) ##TESTING
    updater.dispatcher.add_handler(MessageHandler(Filters.regex('@doYourWorkLahBot /sendLeisurepoll' + "\n"), leisure_add_session_done_clicked))
